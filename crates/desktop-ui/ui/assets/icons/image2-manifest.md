...
| `add.png` | `plus inside a compact circle` | `exec-4fba1352-faed-4cbc-af7f-3daddd540fcb.png` | 16×16 | 新增节点/扫描根动作 |
...
| `preview.png` | `eye` | `exec-46b06717-eee2-4d7c-a9b8-1c00d0dd248e.png` | 16×16 | 媒体预览动作 |
