...
# Stage validation fails closed before any toolchain resolution: an existing
# stage must be rejected with a stable code even when CMake/vcpkg/compilers
# are missing or bogus.
